      ...
      <div className="max-w-4xl w-full border border-green-500/40 rounded-lg overflow-hidden bg-zinc-950 shadow-2xl shadow-green-500/10">
        ...
        <div className="bg-zinc-900 px-4 py-2.5 flex items-center justify-between border-b border-green-500/20">
          ...
          <span className="text-xs text-zinc-400 font-sans font-medium tracking-wide">
            user@gnome-terminal: ~ (app/page.tsx)
          </span>
          <div className="w-12" />
        </div>
        ...
        <div className="p-6 md:p-10 space-y-8">
          <div className="space-y-3">
            ...
            <p className="text-zinc-400 text-sm md:text-base">
              Ubuntu Web Terminal Emulator — Next.js App Router Structure
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-5 bg-black/80 border border-green-500/40 rounded-md">
              ...
              <ul className="text-zinc-300 space-y-2 text-sm">
                <li className="flex items-center gap-2"><span className="text-green-400">✓</span> VFS Navigation (`cd`, `mkdir`, `rmdir`)</li>
            ...
            <div className="p-5 bg-black/80 border border-emerald-500/40 rounded-md">
              ...
              <ul className="text-zinc-300 space-y-2 text-sm">
                <li className="flex items-center gap-2"><span className="text-emerald-400">→</span> Directory: <code className="text-green-400">/app/page.tsx</code></li>
                <li className="flex items-center gap-2"><span className="text-emerald-400">→</span> Package: <code className="text-green-400">next/navigation</code></li>
                <li className="flex items-center gap-2"><span className="text-emerald-400">→</span> Pathname: <code className="text-green-400">{pathname}</code></li>
              </ul>
            </div>
          </div>
